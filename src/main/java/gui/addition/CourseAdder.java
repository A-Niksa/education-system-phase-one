...
import gui.Template;
import gui.enrolment.CoursesListEditor;
import gui.main.MainMenu;
import logic.menus.addition.CourseConstruction;
...
import utils.timing.DateLabelFormatter;
...
public class CourseAdder extends Template {
    ...
    public CourseAdder(MainFrame mainFrame, MainMenu mainMenu, Professor operatingProfessor) {
